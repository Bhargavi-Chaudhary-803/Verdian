  ...
  return (
    <div style={{ minHeight:"100vh", background:"#050a07", overflowX:"hidden", position:"relative" }}>
      ...
      <div style={{ position:"fixed", inset:0, zIndex:0, pointerEvents:"none", overflow:"hidden" }}>
        <div style={{ position:"absolute", width:500, height:500, borderRadius:"50%", background:"radial-gradient(circle, rgba(34,197,94,0.07) 0%, transparent 70%)", top:"-100px", left:"-100px", animation:"floatOrb 12s ease-in-out infinite" }} />
        <div style={{ position:"absolute", width:400, height:400, borderRadius:"50%", background:"radial-gradient(circle, rgba(59,130,246,0.05) 0%, transparent 70%)", top:"20%", right:"-80px", animation:"floatOrb 15s ease-in-out infinite 3s" }} />
        <div style={{ position:"absolute", width:300, height:300, borderRadius:"50%", background:"radial-gradient(circle, rgba(34,197,94,0.05) 0%, transparent 70%)", bottom:"10%", left:"30%", animation:"floatOrb 10s ease-in-out infinite 6s" }} />
      </div>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          <svg width="32" height="32" viewBox="0 0 32 32">
            ...
            <polygon points="16,7 25,12 25,20 16,25 7,20 7,12" fill="rgba(34,197,94,0.1)" stroke="#22c55e" strokeWidth="1"/>
            <circle cx="16" cy="16" r="4" fill="#22c55e" opacity="0.9"/>
          </svg>
          <span style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:18, color:"#e8f5ee", letterSpacing:"-0.03em" }}>VERDIAN</span>
        </div>
        ...
        <div style={{ display:"flex", gap:10 }}>
          <button style={{ padding:"8px 20px", borderRadius:8, background:"transparent", border:"1px solid rgba(34,197,94,0.25)", color:"#6b8c78", cursor:"pointer", fontSize:13, fontFamily:"'DM Sans',sans-serif", transition:"all .2s" }}
          ...
          <button className="glow-btn" style={{ padding:"8px 20px", borderRadius:8, background:"#22c55e", border:"none", color:"#050a07", cursor:"pointer", fontSize:13, fontFamily:"'DM Sans',sans-serif", fontWeight:700 }}
      ...
      <div ref={heroRef} style={{ position:"relative", zIndex:1, paddingTop:160, paddingBottom:100, textAlign:"center", maxWidth:900, margin:"0 auto", padding:"160px 32px 100px" }}>
        ...
        {/* Main headline */}
        <h1 className="hero-headline" style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:"clamp(38px,5.5vw,72px)", lineHeight:1.08, letterSpacing:"-0.04em", color:"#e8f5ee", marginBottom:24 }}>
        ...
        <div className="hero-cta" style={{ display:"flex", gap:14, justifyContent:"center", flexWrap:"wrap" }}>
          <button className="glow-btn" style={{ padding:"14px 36px", borderRadius:12, background:"#22c55e", border:"none", color:"#050a07", fontSize:15, fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, cursor:"pointer", letterSpacing:"-0.01em" }}
            onClick={() => onNavigate("auth")}>
            Start for free →
          </button>
          <button style={{ padding:"14px 36px", borderRadius:12, background:"transparent", border:"1px solid rgba(255,255,255,0.08)", color:"#a0b8a8", fontSize:15, fontFamily:"'DM Sans',sans-serif", cursor:"pointer", transition:"all .2s" }}
          ...
          <div style={{ borderRadius:20, border:"1px solid rgba(34,197,94,0.12)", background:"rgba(10,20,14,0.8)", backdropFilter:"blur(20px)", padding:24, textAlign:"left", maxWidth:700, margin:"0 auto", boxShadow:"0 40px 80px rgba(0,0,0,0.5)" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:20 }}>
              ...
              <div style={{ flex:1, height:20, borderRadius:6, background:"rgba(255,255,255,0.04)", marginLeft:8, display:"flex", alignItems:"center", paddingLeft:10 }}>
                <span style={{ fontSize:10, color:"#2d4a38" }}>verdian.ai/dashboard</span>
              </div>
            </div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:12, marginBottom:12 }}>
              {[["♻️ Recyclable","38%","#3b82f6"],["🌿 Organic","42%","#22c55e"],["⚠️ Hazardous","8%","#ef4444"]].map(([l,v,c],i)=>(
                <div key={i} style={{ padding:"12px 14px", borderRadius:10, background:`${c}08`, border:`1px solid ${c}20` }}>
                  <div style={{ fontSize:11, color:"#6b8c78", marginBottom:6 }}>{l}</div>
                  <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:22, color:c, letterSpacing:"-0.03em" }}>{v}</div>
            ...
            <div style={{ padding:"12px 16px", borderRadius:10, background:"rgba(34,197,94,0.05)", border:"1px solid rgba(34,197,94,0.1)", display:"flex", alignItems:"center", gap:12 }}>
              ...
              <div style={{ padding:"3px 10px", borderRadius:100, background:"rgba(34,197,94,0.1)", border:"1px solid rgba(34,197,94,0.2)", fontSize:11, color:"#22c55e", fontWeight:700, flexShrink:0 }}>94% conf.</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={{ maxWidth:900, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:0 }}>
          {stats.map((s,i) => (
            <div key={i} className="stat-item" style={{ textAlign:"center", padding:"0 24px", borderRight: i < 3 ? "1px solid rgba(34,197,94,0.08)" : "none" }}>
              ...
              <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:34, color:"#22c55e", letterSpacing:"-0.04em", lineHeight:1 }}>{s.val}</div>
      ...
      <div style={{ position:"relative", zIndex:1, padding:"96px 48px" }}>
        <div style={{ maxWidth:960, margin:"0 auto" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:16 }}>
            ...
            <span style={{ fontSize:11, color:"#22c55e", fontWeight:700, letterSpacing:"0.12em" }}>CAPABILITIES</span>
            <div style={{ height:1, flex:1, background:"linear-gradient(90deg, rgba(34,197,94,0.3), transparent)" }} />
          </div>
          <h2 style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:"clamp(28px,3.5vw,44px)", letterSpacing:"-0.03em", color:"#e8f5ee", textAlign:"center", marginBottom:12 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:20 }}>
            {[
              { icon:"🤖", title:"AI Waste Classifier", desc:"Upload a photo or type a description. Our model returns category, confidence score, bin color, and disposal instructions in under 2 seconds.", tag:"94% accuracy", color:"#22c55e" },
              { icon:"🗺️", title:"Live Hotspot Map", desc:"Interactive Leaflet map overlays municipal hotspots and citizen-logged waste pins. Filter by priority. Dispatch trucks from the admin panel.", tag:"Real-time", color:"#3b82f6" },
              { icon:"📊", title:"Smart Analytics", desc:"Track recycling rates, CO₂ savings, weekly collection volume and category breakdowns. Full leaderboard for citizen gamification.", tag:"Live data", color:"#f59e0b" },
              { icon:"📍", title:"Geo-tagged Logging", desc:"Log waste items with GPS coordinates. Every logged item appears as a pin on the city map — giving municipalities precise data on waste origins.", tag:"GPS-enabled", color:"#8b5cf6" },
            ].map((f,i) => (
              <div key={i} className="feature-card" style={{ padding:32, borderRadius:20, background:"rgba(10,18,12,0.6)", border:"1px solid rgba(34,197,94,0.08)", backdropFilter:"blur(10px)", cursor:"pointer" }}>
                <div style={{ display:"flex", alignItems:"flex-start", gap:20 }}>
                  <div className="feat-icon" style={{ width:52, height:52, borderRadius:14, background:`${f.color}10`, border:`1px solid ${f.color}20`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:24, flexShrink:0 }}>
                    {f.icon}
                  </div>
                  <div style={{ flex:1 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8 }}>
                      <span style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:16, color:"#e8f5ee" }}>{f.title}</span>
                      <span style={{ fontSize:10, padding:"2px 8px", borderRadius:100, background:`${f.color}12`, border:`1px solid ${f.color}25`, color:f.color, fontWeight:700, letterSpacing:"0.05em" }}>{f.tag}</span>
                    </div>
        ...
        <div style={{ maxWidth:960, margin:"0 auto", textAlign:"center" }}>
          <div style={{ padding:"32px", borderRadius:20, background:"rgba(34,197,94,0.03)", border:"1px solid rgba(34,197,94,0.08)" }}>
            ...
            <div style={{ display:"flex", gap:24, justifyContent:"center", flexWrap:"wrap" }}>
              {["🏙️ Delhi","🌆 Mumbai","🏛️ Bengaluru","🌃 Hyderabad","🌉 Chennai"].map((c,i) => (
      ...
      <div style={{ position:"relative", zIndex:1, padding:"80px 48px 100px", textAlign:"center" }}>
        <div style={{ maxWidth:600, margin:"0 auto" }}>
          <div style={{ position:"relative", padding:"60px 40px", borderRadius:24, overflow:"hidden", background:"linear-gradient(135deg, rgba(34,197,94,0.08) 0%, rgba(10,20,14,0.9) 100%)", border:"1px solid rgba(34,197,94,0.15)" }}>
            ...
            <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:"clamp(24px,3vw,36px)", color:"#e8f5ee", letterSpacing:"-0.03em", marginBottom:12, lineHeight:1.15 }}>
            ...
            <button className="glow-btn" style={{ padding:"16px 44px", borderRadius:14, background:"#22c55e", border:"none", color:"#050a07", fontSize:16, fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, cursor:"pointer", letterSpacing:"-0.01em" }}
              onClick={() => onNavigate("auth")}>
              Get started free →
            </button>
          </div>
      ...
      <div style={{ position:"relative", zIndex:1, borderTop:"1px solid rgba(34,197,94,0.06)", padding:"24px 48px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <div style={{ display:"flex", alignItems:"center", gap:8 }}>
          ...
          <span style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:13, color:"#2d4a38" }}>VERDIAN</span>
        </div>
    ...
    <div style={{ width:230, minHeight:"100vh", background:"#0a0f0d", borderRight:"1px solid #1e3028", display:"flex", flexDirection:"column", padding:"0 0 20px", flexShrink:0, position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ padding:"20px 18px 16px", borderBottom:"1px solid #1e3028" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div>
            <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:16, color:"#e8f5ee", letterSpacing:"-0.02em" }}>VERDIAN</div>
            <div style={{ fontSize:9, color:"#2d4a38", fontWeight:600, textTransform:"uppercase", letterSpacing:1 }}>Waste Intelligence</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ margin:"12px 12px 8px", padding:"12px 14px", borderRadius:12,
        ...
        <div style={{ fontSize:9, color: user.role==="admin" ? "#ef4444" : "#22c55e", fontWeight:700, textTransform:"uppercase", letterSpacing:1, marginBottom:4 }}>
        ...
        <div style={{ fontSize:10, color:"#6b8c78", marginTop:2, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{user.email}</div>
      </div>

      {/* Nav section label */}
      <div style={{ padding:"8px 18px 4px" }}>
        <div style={{ fontSize:9, color:"#2d4a38", fontWeight:700, textTransform:"uppercase", letterSpacing:1.5 }}>Navigation</div>
      </div>
      ...
      <div style={{ margin:"8px 12px 12px", padding:14, borderRadius:12, background:"rgba(34,197,94,0.04)", border:"1px solid rgba(34,197,94,0.08)", textAlign:"center" }}>
        <svg width="48" height="48" viewBox="0 0 48 48" style={{ margin:"0 auto 8px", display:"block" }}>
          ...
          <text x="24" y="27" textAnchor="middle" fontSize="10" fontWeight="700" fill="#22c55e" fontFamily="'Plus Jakarta Sans',sans-serif">
            {user.green_points||0}
          </text>
          <text x="24" y="36" textAnchor="middle" fontSize="6" fill="#6b8c78">pts</text>
        </svg>
        <div style={{ fontSize:10, color:"#6b8c78" }}>Green Points</div>
      </div>
  ...
  return (
    <div style={{ height:64, background:"rgba(10,15,13,0.95)", borderBottom:"1px solid #1e3028", display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 28px", flexShrink:0, backdropFilter:"blur(12px)", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:16 }}>
        <div>
          <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:17, color:"#e8f5ee", letterSpacing:"-0.02em" }}>{title}</div>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:16 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10, padding:"6px 12px 6px 6px", borderRadius:10, border:"1px solid #1e3028", background:"rgba(34,197,94,0.04)", cursor:"pointer", transition:"all .2s" }}
          ...
          <div>
            ...
            <div style={{ fontSize:9, color:"#6b8c78", textTransform:"capitalize" }}>{user.role}</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div style={{ position:"relative", borderRadius:20, overflow:"hidden", padding:"28px 32px", background:"linear-gradient(135deg, #091409 0%, #0a1a0e 60%, #061009 100%)", border:"1px solid rgba(34,197,94,0.12)" }}>
        ...
        <div style={{ position:"relative", zIndex:1 }}>
          <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:6 }}>
            <div style={{ width:6, height:6, borderRadius:"50%", background:"#22c55e", boxShadow:"0 0 6px #22c55e" }} />
            <span style={{ fontSize:11, color:"#6b8c78", fontWeight:600, letterSpacing:"0.06em" }}>DASHBOARD</span>
          </div>
          <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:26, color:"#e8f5ee", letterSpacing:"-0.03em", marginBottom:6 }}>
          ...
          <div style={{ display:"flex", gap:8, flexWrap:"wrap" }}>
            {[["🏆","Eco Hero","rgba(34,197,94,0.1)","rgba(34,197,94,0.2)","#22c55e"],
              ["🔥",`${profile.streak||0} day streak`,"rgba(245,158,11,0.1)","rgba(245,158,11,0.2)","#f59e0b"],
              ["⭐",`${profile.green_points||0} pts`,"rgba(59,130,246,0.1)","rgba(59,130,246,0.2)","#3b82f6"]
            ].map(([icon,label,bg,border,color],i) => (
              <div key={i} style={{ display:"flex", alignItems:"center", gap:5, padding:"5px 12px", borderRadius:100, background:bg, border:`1px solid ${border}`, fontSize:12, color, fontWeight:600 }}>
                {icon} {label}
              </div>
            ))}
          </div>
          ...
          return (
            <div key={i} style={{ position:"relative", padding:"18px 20px", borderRadius:16, background:"#162019", border:"1px solid #1e3028", overflow:"hidden", transition:"transform .2s,box-shadow .2s", cursor:"default" }}
              ...
              <div style={{ position:"relative", display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14 }}>
                <div>
                  <div style={{ fontSize:11, color:"#6b8c78", fontWeight:500, marginBottom:8 }}>{s.label}</div>
                  <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:28, fontWeight:800, color:"#e8f5ee", letterSpacing:"-0.04em", lineHeight:1 }}>
              ...
              <div style={{ marginTop:6, fontSize:10, color:"#6b8c78" }}>{Math.round(pct)}% of {s.suffix ? s.max + s.suffix : `${s.max} target`}</div>
            </div>
          );
        })}
      </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:18 }}>
        ...
        <div style={{ padding:22, borderRadius:16, background:"#162019", border:"1px solid #1e3028" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
            <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:14, color:"#e8f5ee" }}>Recent Activity</div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                {logs.map((log,i) => (
                  <div key={i} style={{ display:"flex", alignItems:"center", gap:10, padding:"9px 12px", borderRadius:10, background:"rgba(255,255,255,0.02)", border:"1px solid rgba(255,255,255,0.04)", transition:"all .2s" }}
                    ...
                    <div style={{ width:30, height:30, borderRadius:8, background:`${catColor[log.category]}12`, border:`1px solid ${catColor[log.category]}25`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, flexShrink:0 }}>
                    ...
                    <div style={{ flex:1, minWidth:0 }}>
                      ...
                      <div style={{ fontSize:10, color:"#6b8c78" }}>{log.category} · {new Date(log.created_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"})}</div>
                    </div>
                    <div style={{ padding:"2px 8px", borderRadius:100, background:"rgba(34,197,94,0.1)", fontSize:11, color:"#22c55e", fontWeight:700, flexShrink:0 }}>+{log.points_earned}pts</div>
                  </div>
                ))}
              </div>
            )
        ...
        {/* Weekly mini chart */}
        <div style={{ padding:22, borderRadius:16, background:"#162019", border:"1px solid #1e3028" }}>
          <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:14, color:"#e8f5ee", marginBottom:4 }}>This Week</div>
          <div style={{ fontSize:11, color:"#6b8c78", marginBottom:20 }}>Items logged per day</div>
            ...
            {weekBars.map((v,i) => {
              ...
              return (
                <div key={i} style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:5 }}>
                  ...
                  <div style={{ fontSize:9, color: isMax ? "#22c55e" : "#6b8c78", fontWeight: isMax ? 700 : 400 }}>{days[i]}</div>
                </div>
              );
            })}
          </div>
          ...
          <div style={{ marginTop:20, paddingTop:16, borderTop:"1px solid rgba(34,197,94,0.08)" }}>
            <div style={{ fontSize:11, color:"#6b8c78", marginBottom:10, fontWeight:600 }}>🌱 Quick Guide</div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:6 }}>
              {wasteCategories.map((wc,i) => (
                <div key={i} style={{ display:"flex", alignItems:"center", gap:6, padding:"6px 8px", borderRadius:8, background:`${wc.color}08`, border:`1px solid ${wc.color}15` }}>
                  ...
                  <span style={{ fontSize:11, color:wc.color, fontWeight:600 }}>{wc.label}</span>
                </div>
              ))}
            </div>
          </div>
