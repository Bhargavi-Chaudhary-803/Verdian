...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800&family=Inter:wght@400;500;600&display=swap');
    ...
    <div style={{ minHeight:"100vh", background:"#050a07", overflowX:"hidden", position:"relative" }}>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <span style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:16, color:"#e8f5ee", letterSpacing:"0.06em" }}>VERDIAN</span>
        </div>
      ...
      <div ref={heroRef} style={{ position:"relative", zIndex:1, paddingTop:160, paddingBottom:100, textAlign:"center", maxWidth:900, margin:"0 auto", padding:"160px 32px 100px" }}>
        ...
        {/* Main headline */}
        <h1 className="hero-headline" style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:"clamp(36px,5vw,66px)", lineHeight:1.12, letterSpacing:"0.02em", color:"#e8f5ee", marginBottom:24 }}>
      ...
      <div style={{ position:"relative", zIndex:1, borderTop:"1px solid rgba(34,197,94,0.06)", padding:"24px 48px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <div style={{ display:"flex", alignItems:"center", gap:8 }}>
          ...
          <span style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:13, color:"#2d4a38", letterSpacing:"0.06em", fontFamily:"'Plus Jakarta Sans',sans-serif" }}>VERDIAN</span>
        </div>
    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      ...
      <div className="fade-in" style={{ width:"100%", maxWidth:440 }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:40, justifyContent:"center" }}>
          ...
          <span className="syne" style={{ fontWeight:700, fontSize:22, color:C.text, letterSpacing:"0.06em", fontFamily:"'Plus Jakarta Sans',sans-serif" }}>VERDIAN</span>
        </div>
    ...
    <div style={{ width:230, minHeight:"100vh", background:"#0a0f0d", borderRight:"1px solid #1e3028", display:"flex", flexDirection:"column", padding:"0 0 20px", flexShrink:0, position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ padding:"20px 18px 16px", borderBottom:"1px solid #1e3028" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div>
            <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:15, color:"#e8f5ee", letterSpacing:"0.06em", fontFamily:"'Plus Jakarta Sans',sans-serif" }}>VERDIAN</div>
