    ...
    <div className="fade-in" style={{ padding:28, display:"flex", flexDirection:"column", gap:24 }}>
      ...
      <div className="card" style={{ padding:24 }}>
        <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:16 }}>
          <div style={{ width:36, height:36, borderRadius:10, background:C.accentGlow, border:`1px solid ${C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
            <ScanLine size={16} color={C.accent}/>
          </div>
          <div>
            <div className="heading" style={{ fontWeight:700, fontSize:16, color:C.text }}>Waste Assistant</div>
            <div style={{ fontSize:12, color:C.muted }}>Ask anything about waste disposal, recycling, or sustainability</div>
          </div>
        </div>
        <iframe
          src="https://winrchatbot.netlify.app"
          style={{
            width:"100%",
            height:560,
            border:"none",
