...
function LandingPage({ onNavigate }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f0fdf4", overflowX:"hidden" }}>
      <nav style={{
...
function AuthPage({ onLogin }) {
  ...
  // ── Demo bypass: clicking Admin Demo → skips credentials entirely ────────────
  const handleDemoAdmin = () => {
    onLogin({ id:"demo-admin", name:"Demo Admin", email:"admin@verdian.ai", role:"admin",
      green_points:0, co2_saved:0, streak:0 });
  };
    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      ...
      <div className="fade-in" style={{ width:"100%", maxWidth:440 }}>
            ...
            <div style={{ display:"flex", background:C.surface, borderRadius:10, padding:4, border:`1px solid ${C.border}` }}>
              <button onClick={() => setRole("user")}
                style={{ flex:1, padding:"9px 0", borderRadius:8, border:"none", cursor:"pointer", fontFamily:"'DM Sans',sans-serif", fontWeight:600, fontSize:13, transition:"all .2s",
                  background:role==="user"?C.accent:"transparent", color:role==="user"?"#ffffff":C.muted, display:"flex", alignItems:"center", justifyContent:"center", gap:6 }}>
        ...
        <div style={{ marginTop:16, padding:"16px 20px", borderRadius:14, background:"#ffffff", border:`1px solid ${C.border}`, boxShadow:"0 1px 4px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            <button onClick={() => onLogin({ id:"demo-citizen", name:"Demo Citizen", email:"citizen@verdian.ai", role:"user", green_points:120, co2_saved:3.2, streak:5 })}
              style={{ flex:1, padding:"9px 0", borderRadius:9, border:`1px solid ${C.border}`, background:C.accentGlow, color:C.accent, cursor:"pointer", fontFamily:"'DM Sans',sans-serif", fontWeight:600, fontSize:13, display:"flex", alignItems:"center", justifyContent:"center", gap:6, transition:"all .2s" }}
              onMouseEnter={e=>{e.currentTarget.style.background=C.accent;e.currentTarget.style.color="#fff";}}
              onMouseLeave={e=>{e.currentTarget.style.background=C.accentGlow;e.currentTarget.style.color=C.accent;}}>
              <Leaf size={13}/> Citizen Demo
            </button>
            <button onClick={handleDemoAdmin}
              style={{ flex:1, padding:"9px 0", borderRadius:9, border:"1px solid rgba(220,38,38,0.2)", background:"rgba(220,38,38,0.06)", color:"#dc2626", cursor:"pointer", fontFamily:"'DM Sans',sans-serif", fontWeight:600, fontSize:13, display:"flex", alignItems:"center", justifyContent:"center", gap:6, transition:"all .2s" }}
...
function UserDashboard({ user }) {
  ...
  return (
    <div className="fade-in" style={{ padding:28, display:"flex", flexDirection:"column", gap:22 }}>
      {/* Hero Banner */}
      <div style={{ position:"relative", borderRadius:20, overflow:"hidden", padding:"28px 32px", background:"linear-gradient(135deg,#f0fdf4 0%,#dcfce7 60%,#f0fdf4 100%)", border:"1px solid #bbf7d0" }}>
        <svg style={{ position:"absolute", right:0, top:0, height:"100%", width:"45%", opacity:1 }} viewBox="0 0 380 160" preserveAspectRatio="xMaxYMid slice">
          <defs><radialGradient id="bg1" cx="60%" cy="50%"><stop offset="0%" stopColor="#16a34a" stopOpacity="0.15"/><stop offset="100%" stopColor="#16a34a" stopOpacity="0"/></radialGradient></defs>
          <ellipse cx="280" cy="80" rx="160" ry="100" fill="url(#bg1)"/>
          <circle cx="300" cy="80" r="70" fill="none" stroke="#16a34a" strokeWidth="0.5" opacity="0.3" strokeDasharray="4 6"/>
          <circle cx="300" cy="80" r="45" fill="none" stroke="#16a34a" strokeWidth="0.5" opacity="0.4" strokeDasharray="3 8"/>
          <circle cx="300" cy="80" r="22" fill="rgba(22,163,74,0.08)" stroke="#16a34a" strokeWidth="1" opacity="0.7"/>
          {[0,45,90,135,180,225,270,315].map((deg,i)=>{ const r=deg*Math.PI/180,x=300+70*Math.cos(r),y=80+70*Math.sin(r); return <circle key={i} cx={x} cy={y} r="2.5" fill="#16a34a" opacity={i%2===0?0.5:0.3}/>; })}
        </svg>
        <div style={{ position:"relative", zIndex:1 }}>
          <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:6 }}>
            <div style={{ width:6, height:6, borderRadius:"50%", background:"#16a34a", boxShadow:"0 0 6px rgba(22,163,74,0.5)" }} />
            <span style={{ fontSize:12, color:"#16a34a", fontWeight:700, letterSpacing:"0.08em" }}>CITIZEN DASHBOARD</span>
          </div>
          <div className="heading" style={{ fontWeight:800, fontSize:26, color:"#14532d", marginBottom:6 }}>Hi, {profile.name?.split(" ")[0]}!</div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:14 }}>
        {[
          ...
          return (
            <div key={i} style={{ position:"relative", padding:"18px 20px", borderRadius:16, background:"#ffffff", border:`1px solid ${C.border}`, overflow:"hidden", transition:"transform .2s,box-shadow .2s" }}
              ...
              <div style={{ position:"relative", display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14 }}>
                <div>
                  ...
                  <div className="heading" style={{ fontSize:28, fontWeight:800, color:C.text, lineHeight:1 }}>{loading?"—":s.value}{s.suffix}</div>
                </div>
              ...
              <div style={{ height:3, borderRadius:2, background:`${s.color}15`, overflow:"hidden" }}>
                <div style={{ height:"100%", width:`${tick?pct:0}%`, background:`linear-gradient(90deg,${s.color}cc,${s.color})`, borderRadius:2, transition:"width 1.2s cubic-bezier(0.34,1.56,0.64,1)" }}/>
              </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:18 }}>
        <div style={{ padding:22, borderRadius:16, background:C.card, border:`1px solid ${C.border}` }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
            <div className="heading" style={{ fontWeight:700, fontSize:14, color:C.text }}>Recent Activity</div>
          ...
          {loading ? <div style={{ textAlign:"center", padding:"20px 0" }}><Spinner/></div> :
            logs.length===0 ? (
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                {logs.map((log,i)=>(
                  <div key={i} style={{ display:"flex", alignItems:"center", gap:10, padding:"9px 12px", borderRadius:10, background:"rgba(22,163,74,0.03)", border:"1px solid #d1fae5", transition:"all .2s" }}
                    onMouseEnter={e=>{e.currentTarget.style.background="rgba(22,163,74,0.08)";e.currentTarget.style.borderColor="#86efac"}}
        ...
        <div style={{ padding:22, borderRadius:16, background:C.card, border:`1px solid ${C.border}` }}>
          <div className="heading" style={{ fontWeight:700, fontSize:14, color:C.text, marginBottom:4 }}>This Week</div>
            ...
            {weekBars.map((v,i)=>{ const days=["M","T","W","T","F","S","S"]; const isMax=v===maxBar&&v>0;
              return (<div key={i} style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:5 }}>
                <div style={{ width:"100%", borderRadius:"4px 4px 0 0", height:`${(v/maxBar)*80}px`, minHeight:v>0?4:2,
                  background:isMax?"linear-gradient(180deg,#16a34a,#15803d)":v>0?"rgba(22,163,74,0.35)":"rgba(22,163,74,0.1)",
...
function MapView() {
  ...
  useEffect(() => {
    wasteLogsRef.current = wasteLogs;
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div className="card" style={{ padding:18 }}>
            ...
            <div style={{ fontSize:12, color:C.muted, marginBottom:12 }}>
              {hotspots.length} zones · {wasteLogs.filter(l=>l.lat&&l.lng).length} pinned logs ({wasteLogs.length} total)
            </div>
            <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
  ...
  return (
    <div className="fade-in" style={{ padding:28, display:"flex", flexDirection:"column", gap:24 }}>
      {loading ? <div style={{ textAlign:"center", padding:60 }}><Spinner size={32}/></div> : (<>
        ...
        {isAdmin&&(
          <div className="card" style={{ padding:24 }}>
            <div className="heading" style={{ fontWeight:700, fontSize:16, color:C.text, marginBottom:20 }}>Today's Collection Schedule</div>
            <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
    ...
    <div className="fade-in" style={{ padding:28, display:"flex", flexDirection:"column", gap:24 }}>
      ...
      {loading ? <div style={{ textAlign:"center", padding:40 }}><Spinner size={32}/></div> : (<>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:20 }}>
          ...
          {/* Today's Schedule */}
          <div className="card" style={{ padding:24 }}>
            <div className="heading" style={{ fontWeight:700, fontSize:15, color:C.text, marginBottom:16 }}>Today's Schedule</div>
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
          ...
          <div key={i} className="card" style={{ padding:22, borderColor:`${col}25` }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              ...
              <div style={{ display:"flex", gap:10, alignItems:"center" }}>
                <div style={{ textAlign:"right" }}>
                  <div className="heading" style={{ fontSize:20, fontWeight:800, color:C.text }}>{h.volume} kg</div>
