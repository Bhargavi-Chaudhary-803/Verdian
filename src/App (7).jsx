    ...
    <div className="fade-in" style={{ padding:28, display:"flex", flexDirection:"column", gap:22 }}>
      ...
      <div style={{ position:"relative", borderRadius:20, overflow:"hidden", padding:"28px 32px", background:"linear-gradient(135deg,#f0fdf4 0%,#dcfce7 60%,#f0fdf4 100%)", border:"1px solid #bbf7d0" }}>
        ...
        <div style={{ position:"relative", zIndex:1 }}>
          ...
          <div className="syne" style={{ fontWeight:800, fontSize:26, color:"#14532d", marginBottom:6 }}>Hi, {profile.name?.split(" ")[0]}!</div>
      ...
      <div className="card" style={{ padding:24, background:"linear-gradient(135deg,#fff5f5 0%,#fee2e2 100%)", borderColor:"rgba(220,38,38,.2)" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            ...
            <div className="syne" style={{ fontSize:24, fontWeight:800, color:"#7f1d1d" }}>Municipal Dashboard</div>
