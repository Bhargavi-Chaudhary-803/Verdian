...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@500;600;700&family=DM+Sans:wght@300;400;500;600&display=swap');
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .syne { font-family: 'Quicksand', sans-serif; font-weight: 700; letter-spacing: 0.04em; }
    ...
    <div style={{ minHeight:"100vh", background:"#050a07", overflowX:"hidden", position:"relative" }}>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <span style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:18, color:"#e8f5ee", letterSpacing:"0.18em" }}>VERDIAN</span>
        </div>
      ...
      <div ref={heroRef} style={{ position:"relative", zIndex:1, paddingTop:160, paddingBottom:100, textAlign:"center", maxWidth:900, margin:"0 auto", padding:"160px 32px 100px" }}>
        ...
        {/* Main headline */}
        <h1 className="hero-headline" style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:"clamp(36px,5vw,66px)", lineHeight:1.12, letterSpacing:"0.02em", color:"#e8f5ee", marginBottom:24 }}>
        ...
        <div className="hero-cta" style={{ display:"flex", gap:14, justifyContent:"center", flexWrap:"wrap" }}>
          <button className="glow-btn" style={{ padding:"14px 36px", borderRadius:12, background:"#22c55e", border:"none", color:"#050a07", fontSize:15, fontFamily:"'Quicksand',sans-serif", fontWeight:700, cursor:"pointer", letterSpacing:"-0.01em" }}
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:12, marginBottom:12 }}>
              {[["♻️ Recyclable","38%","#3b82f6"],["🌿 Organic","42%","#22c55e"],["⚠️ Hazardous","8%","#ef4444"]].map(([l,v,c],i)=>(
                <div key={i} style={{ padding:"12px 14px", borderRadius:10, background:`${c}08`, border:`1px solid ${c}20` }}>
                  ...
                  <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:800, fontSize:22, color:c, letterSpacing:"-0.03em" }}>{v}</div>
        ...
        <div style={{ maxWidth:900, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:0 }}>
          {stats.map((s,i) => (
            <div key={i} className="stat-item" style={{ textAlign:"center", padding:"0 24px", borderRight: i < 3 ? "1px solid rgba(34,197,94,0.08)" : "none" }}>
              ...
              <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:800, fontSize:34, color:"#22c55e", letterSpacing:"-0.04em", lineHeight:1 }}>{s.val}</div>
      ...
      <div style={{ position:"relative", zIndex:1, padding:"96px 48px" }}>
        <div style={{ maxWidth:960, margin:"0 auto" }}>
          ...
          <h2 style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:800, fontSize:"clamp(28px,3.5vw,44px)", letterSpacing:"-0.03em", color:"#e8f5ee", textAlign:"center", marginBottom:12 }}>
                ...
                <div style={{ display:"flex", alignItems:"flex-start", gap:20 }}>
                  ...
                  <div style={{ flex:1 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8 }}>
                      <span style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:16, color:"#e8f5ee" }}>{f.title}</span>
      ...
      <div style={{ position:"relative", zIndex:1, padding:"80px 48px 100px", textAlign:"center" }}>
        <div style={{ maxWidth:600, margin:"0 auto" }}>
          <div style={{ position:"relative", padding:"60px 40px", borderRadius:24, overflow:"hidden", background:"linear-gradient(135deg, rgba(34,197,94,0.08) 0%, rgba(10,20,14,0.9) 100%)", border:"1px solid rgba(34,197,94,0.15)" }}>
            ...
            <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:800, fontSize:"clamp(24px,3vw,36px)", color:"#e8f5ee", letterSpacing:"-0.03em", marginBottom:12, lineHeight:1.15 }}>
            ...
            <button className="glow-btn" style={{ padding:"16px 44px", borderRadius:14, background:"#22c55e", border:"none", color:"#050a07", fontSize:16, fontFamily:"'Quicksand',sans-serif", fontWeight:700, cursor:"pointer", letterSpacing:"-0.01em" }}
              onClick={() => onNavigate("auth")}>
              Get started free →
            </button>
          </div>
      ...
      <div style={{ position:"relative", zIndex:1, borderTop:"1px solid rgba(34,197,94,0.06)", padding:"24px 48px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <div style={{ display:"flex", alignItems:"center", gap:8 }}>
          ...
          <span style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:13, color:"#2d4a38", letterSpacing:"0.18em" }}>VERDIAN</span>
        </div>
    ...
    <div style={{ minHeight:"100vh", background:C.bg, display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      ...
      <div className="fade-in" style={{ width:"100%", maxWidth:440 }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:40, justifyContent:"center" }}>
          ...
          <span className="syne" style={{ fontWeight:700, fontSize:22, color:C.text, letterSpacing:"0.2em" }}>VERDIAN</span>
        </div>
    ...
    <div style={{ width:230, minHeight:"100vh", background:"#0a0f0d", borderRight:"1px solid #1e3028", display:"flex", flexDirection:"column", padding:"0 0 20px", flexShrink:0, position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ padding:"20px 18px 16px", borderBottom:"1px solid #1e3028" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div>
            <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:15, color:"#e8f5ee", letterSpacing:"0.18em" }}>VERDIAN</div>
  ...
  return (
    <div style={{ height:64, background:"rgba(10,15,13,0.95)", borderBottom:"1px solid #1e3028", display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 28px", flexShrink:0, backdropFilter:"blur(12px)", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:16 }}>
        <div>
          <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:17, color:"#e8f5ee", letterSpacing:"-0.02em" }}>{title}</div>
      ...
      <div style={{ position:"relative", borderRadius:20, overflow:"hidden", padding:"28px 32px", background:"linear-gradient(135deg, #091409 0%, #0a1a0e 60%, #061009 100%)", border:"1px solid rgba(34,197,94,0.12)" }}>
        ...
        <div style={{ position:"relative", zIndex:1 }}>
          <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:6 }}>
            <div style={{ width:6, height:6, borderRadius:"50%", background:"#22c55e", boxShadow:"0 0 6px #22c55e" }} />
            <span style={{ fontSize:10, color:"#22c55e", fontWeight:700, letterSpacing:"0.1em" }}>CITIZEN DASHBOARD</span>
          </div>
          <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:800, fontSize:26, color:"#e8f5ee", letterSpacing:"-0.03em", marginBottom:6 }}>
            ...
            <div key={i} style={{ position:"relative", padding:"18px 20px", borderRadius:16, background:"#162019", border:"1px solid #1e3028", overflow:"hidden", transition:"transform .2s,box-shadow .2s", cursor:"default" }}
              ...
              <div style={{ position:"relative", display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14 }}>
                <div>
                  ...
                  <div style={{ fontFamily:"'Quicksand',sans-serif", fontSize:28, fontWeight:800, color:"#e8f5ee", letterSpacing:"-0.04em", lineHeight:1 }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:18 }}>
        ...
        <div style={{ padding:22, borderRadius:16, background:"#162019", border:"1px solid #1e3028" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
            <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:14, color:"#e8f5ee" }}>Recent Activity</div>
        ...
        {/* Weekly mini chart */}
        <div style={{ padding:22, borderRadius:16, background:"#162019", border:"1px solid #1e3028" }}>
          <div style={{ fontFamily:"'Quicksand',sans-serif", fontWeight:700, fontSize:14, color:"#e8f5ee", marginBottom:4 }}>This Week</div>
          ...
          <div style={{ marginTop:20, paddingTop:16, borderTop:"1px solid rgba(34,197,94,0.08)" }}>
            <div style={{ display:"flex", alignItems:"center", gap:5, fontSize:11, color:"#6b8c78", marginBottom:10, fontWeight:600 }}><Leaf size={11} color="#6b8c78"/> Quick Guide</div>
